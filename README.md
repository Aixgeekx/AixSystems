...
|---|---|
| **视图** | 我的一天 / 一周 / 一月 / 一年 |
| **首页工作台** | 工作台模式 / 紧凑应用模式 / 自主控制指挥台 / Aix 智能控制助手 / 事项过载雷达 / 今日专注警报 / 搜索筛选收藏 / 拖拽排序 / 控制台模板 / 主题联动主视觉 / 本地备份状态 |
...
| **Aix 模型接口** | 系统设置可配置 API 地址 / API Key / 模型名，并支持 cc-switch 风格 Provider 预设、OpenAI/Claude/Ollama 协议识别、原子切换、配置备份和官方登录回退；Aix 控制战役、自进化路线图和技能任务图谱可离线编排，首页和成长仪表盘可调用模型生成个人控制建议 |
