...
| **成长系统** | 成长仪表盘 / 成长雷达图 / 习惯追踪 / 目标管理 / 成就徽章 / 周期复盘 / 复习中心 / 复习完成态追踪 / 巩固回流 / 复习强度配置 / 复习智能推荐 / Markdown + HTML 成长报告导出 |
...
产物:`desktop/dist-installer/AixSystems-0.23.2-Setup.exe`(约 80MB NSIS 向导包)
