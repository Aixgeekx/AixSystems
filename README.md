...
| **成长系统** | 成长仪表盘 / 习惯追踪 / 目标管理 / 成就徽章 / 周期复盘 / 复习中心 / 复习完成态追踪 / 巩固回流 / 复习强度配置 / 复习智能推荐 / Markdown + HTML 成长报告导出 |
| **功能中枢** | 主题工作台 / 场景化实用功能入口 / 首页总览主场 |
| **内容工作台** | 分类管理工作台 / 备忘录工作台 / 分层信息卡片 |
| **记录与控制台** | 日记工作台 / 本地系统控制台 / 更完整的高频操作布局 |
...
产物:`desktop/dist-installer/AixSystems-0.23.1-Setup.exe`(约 80MB NSIS 向导包)
