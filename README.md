...
| **记录与控制台** | 日记工作台 / 今日 AI 日计划编排 / 自动化执行面板 / 本地系统控制台 / 更完整的高频操作布局 |
...
| **专注** | 倒计时 / 正计时 / 番茄钟 / 周同比 / 月同比,严格模式,5 款白噪音(Web Audio 实时合成) |
...
产物:`desktop/dist-installer/AixSystems-0.23.4-Setup.exe`(约 80MB NSIS 向导包)
