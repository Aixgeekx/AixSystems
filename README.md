...
- `v0.30.0`：新增超级管理器安全控制矩阵、cc-switch 风格 Provider 管理和手机版底部导航
...
| **Aix 模型接口** | 系统设置可配置 API 地址 / API Key / 模型名，并支持 cc-switch 风格 Provider 预设、原子切换、配置备份和官方登录回退，首页和成长仪表盘可调用模型生成个人控制建议 |
