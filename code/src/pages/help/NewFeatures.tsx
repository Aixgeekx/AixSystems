...
const UPDATES = [
  ...
  { ver: '0.43.0', date: '2026-04-25', items: [
    ...
    '桌面超级管理器新增 PowerShell 7 自愈预检沙盒，把常见问题映射到白名单只读预设且仍需人工确认'
  ]},
  { ver: '0.41.0', date: '2026-04-25', items: [
    ...
    '桌面超级管理器升级 PowerShell 7 安全账本执行底座，优先 pwsh 7 并记录白名单哈希、耗时和输出摘要'
  ]},
  ...
  { ver: '0.38.0', date: '2026-04-25', items: [
    ...
    '系统设置新增 Aix Provider 可信路由，按协议、健康、延迟、官方回退和活跃槽推荐主路由'
  ]},
  { ver: '0.37.0', date: '2026-04-25', items: [
    '首页新增自主控制指挥台，自动合成最高优先级指令、恢复力评分、执行顺序和下一步入口',
    'Aix 中枢新增技能任务图谱，把数据感知、策略生成、权限确认和执行归档组织成可恢复任务链',
    '数据中心新增灾备演练舱，按备份新鲜度、模块覆盖、数据规模和运行环境生成灾备等级与演练步骤'
  ]},
  { ver: '0.36.0', date: '2026-04-25', items: [
    '日记页新增本地情绪-行动关联图谱，仅统计情绪、标签、强度、完成事项、专注和习惯数据，Aix 不读取日记正文',
    '专注页新增 1-5 星质量智能评级，结合时长、严格模式、白噪音偏好和高能时段给出节奏建议',
  ...
  { ver: '0.28.0', date: '2026-04-25', items: [
    ...
    '成长仪表盘新增风险预警中心，识别拖延、低专注和记录不足并给出干预动作'
  ]},
