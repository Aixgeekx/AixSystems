...
| **Aix 内置中枢** | 独立 Aix 主入口 + 控制战役编排器 + 技能库/插件广场 + 插件详情/Schema/版本归档 + OpenAI/Claude/Ollama 本地代理中心；无 API 是离线全能系统工具，有 API 是有灵魂的黑科技系统 |
...
产物: `desktop/dist-installer/AixSystems-0.34.0-Setup.exe` (NSIS 安装包,约 80MB)
