...
- 可继续增强方向：专注月同比趋势、数据导出增强、成长数据便携报告、首页拖拽排序、复习中心完成态追踪

## 下一步候选方向
1. **专注月同比趋势** - 本月 vs 上月专注时长对比
2. **数据导出增强** - 支持更多格式或选择性导出
3. **成长数据便携报告** - 导出成长仪表盘周/月复盘为 JSON/Markdown
4. **复习中心** - 聚合未来记忆曲线复习节点和今日待复习内容
